...
public class ChessMatch {
    ...
    private void validatedSourcePosition(Position position) {
        ...
        if (!board.piece(position).isThereAnyPossibleMove()) {
            throw new ChessException("There is no possible movie for thee chose piece");
        }
    }
    ...
    private void nextTurn() {
        ...
        // jogador atual é brancas? Vira pretas. Do contrário pretas vira brancas
    }
    ...
    private boolean testCheck(Color color){
        ...
        List<Piece> oponnentPiece = piecesOnTheBoard.stream().filter(x->((ChessPiece)x).getColor() == opponent(color) ).collect(Collectors.toList());
        for (Piece p :oponnentPiece){
